...
const TV_REGIONS = [
  ...
  { code: 'br', name: 'Brasil (Globo, CazéTV, SporTV)', flagUrl: 'https://flagcdn.com/w40/br.png', emoji: '🇧🇷' },
  { code: 'co', name: 'Colombia (Caracol, RCN, DGO)', flagUrl: 'https://flagcdn.com/w40/co.png', emoji: '🇨🇴' },
  { code: 'cl', name: 'Chile (CHV, Canal 13, DGO)', flagUrl: 'https://flagcdn.com/w40/cl.png', emoji: '🇨🇱' },
  { code: 'pe', name: 'Perú (América TV, DGO)', flagUrl: 'https://flagcdn.com/w40/pe.png', emoji: '🇵🇪' },
  { code: 'py', name: 'Paraguay (Trece, GEN, Unicanal, DGO)', flagUrl: 'https://flagcdn.com/w40/py.png', emoji: '🇵🇾' },
  { code: 'ec', name: 'Ecuador (Teleamazonas, ECDF, DGO)', flagUrl: 'https://flagcdn.com/w40/ec.png', emoji: '🇪🇨' },
  { code: 'bo', name: 'Bolivia (Unitel, Red Uno, Tigo, DGO)', flagUrl: 'https://flagcdn.com/w40/bo.png', emoji: '🇧🇴' },
  { code: 'uy', name: 'Uruguay (Antel TV, DGO)', flagUrl: 'https://flagcdn.com/w40/uy.png', emoji: '🇺🇾' },
  { code: 've', name: 'Venezuela (DSports, DGO, Inter)', flagUrl: 'https://flagcdn.com/w40/ve.png', emoji: '🇻🇪' },
